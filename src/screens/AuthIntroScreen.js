// src/screens/AuthIntroScreen.js
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 16, textAlign: 'center', color: '#66bb6a', marginVertical: 20 },
  button: { backgroundColor: '#4caf50', paddingVertical: 14, paddingHorizontal: 40, borderRadius: 30 },
  buttonText: { color: '#fff', fontSize: 18 },
  loginText: { marginTop: 20, fontSize: 14, color: '#388e3c' }
});
